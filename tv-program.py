...
def TestTV():
    ...
    print("\033[94m" + f"\U0001F4FA TV1's channel is {TV1.getChannel()} and volume level is {TV1.getVolume()}\U0001F4FA" + "\033[0m")
    print("|" + "\033[35m" +" .  '"*9 + "\033[0m" + "|")
    print("|" + "\033[36m" + " .  '"*9 + "\033[0m" + "|")
    print("|" + "\033[31m" + " .  '"*9 + "\033[0m" + "|")
    print("|" + "-"*45 + "|")
    print("|" + " "*19 + "\033[90mTV #1\033[0m" + " "*21 + "|")
    print("+" + "="*45 + "+")
    print("O-O" + " "*41 + "O-O")
...
# O-O                                         O-O
    ...
    print("|" + "\033[31m" + " .  '"*9 + "\033[0m" + "|")
    print("|" + "-"*45 + "|")
    print("|" + " "*19 + "\033[90mTV #2\033[0m" + " "*21 + "|")
    print("+" + "="*45 + "+")
    print("O-O" + " "*41 + "O-O")
